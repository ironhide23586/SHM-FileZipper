...
namespace SHM_Zipper
{
    ...
    public class SHMZipper
    {
        ...
        /// <summary>
        /// Sets the diagonal elements of the probability matrix to '0'.
        /// </summary>
        ...
        public bool processWorkingMatrix(bool dSelected, bool revDSelected, bool rSelected, bool cSelected, uint selRow, uint selCol)
        {
            ...
            setProbabilityMatrixDiagonalToZero();
        ...
        public void getMaxProbabilityIndex(ref uint i, ref uint j, ref uint maxProbabilityVal)
        {
            uint[] row = new uint[4];
            uint[] col = new uint[4];
            ...
            Console.WriteLine(maxProbabilityVal);
            i = row[maxProbIndex];
            j = col[maxProbIndex];
        }
        ...
        public void greatestProbability(uint lRow, uint hRow, uint lCol, uint hCol, ref uint probability, ref uint row, ref uint col)
        {
            probability = 0;
