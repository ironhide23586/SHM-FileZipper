...
namespace SHM_FileZipper
{
    class Program
    {
        ...
        {
            //Console.WriteLine((double)(3d / 7d));
            ...
            //    {
            //        if (sz.probabilityMatrix[i, j] == 0)
            //        {
            //            //Console.WriteLine("ZERO PROBABLITY COORDINATES -> ({0}, {1})", i, j);
            //            //Console.Beep();
            //        }
            ...
            st.Start();
            sz.processWorkingMatrix(true, false, false, false, 0, 0);
            //sz.getMaxProbabilityIndex(ref r, ref c, ref mP);
            //sz.predictAndPutBitAtIndex(true, false, false, false, 0, 0, r, c);
            //sz.probabilityMatrix[r, c] = 0;
            //sz.getMaxProbabilityIndex(ref r, ref c, ref mP);
            st.Stop();
            Console.WriteLine("Elapsed ticks = " + st.ElapsedTicks + "\nNo. of error bits = " + sz.wrongCount + "\nNo. of bits in file = " + sz.FileMatrix.BinaryMatrixNoOfBitsInSide * sz.FileMatrix.BinaryMatrixNoOfBitsInSide);
            Console.WriteLine("Error %age = " + (double)((double)sz.wrongCount / (double)(sz.FileMatrix.BinaryMatrixNoOfBitsInSide * sz.FileMatrix.BinaryMatrixNoOfBitsInSide)));
            //sz.greatestProbability(2, 5, 2, 4, ref mP, ref r, ref c);
            //Console.WriteLine("Max probability index = (" + r + ", " + c + ")\nMax Probability = " + mP + "\nTime = " + st.ElapsedTicks);
            Console.Read();
            //processDaBadBwoy(sz);
