...
namespace SHM_FileZipper
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            byte[] h = File.ReadAllBytes("The Judas Kiss.mp3");
            //byte[] h = { 255 };
            byte[] l = { 5, 9, 7, 6 };
            sz = new SHMZipper(h);
            //lol(h);
            ...
            calculate(sz);
            //sz.processWorkingMatrix(false, false, false, false, 0, 0);
            //Console.WriteLine(sz.FileMatrix.StringRepresentation + "\n");
            //Console.WriteLine(sz.workingMatrix.StringRepresentation);
            //for (uint i = 0; i < sz.FileMatrix.BinaryMatrixNoOfBitsInSide; i++)
            //{
            //    for (uint j = 0; j < sz.FileMatrix.BinaryMatrixNoOfBitsInSide; j++)
            //    {
            //        Console.Write(sz.FileMatrix.BitAt2DIndex(i, j));
            //    }
            //    Console.WriteLine();
            //}
            //sz.initializeWorkingMatrix(false, true, true, true, 4, 6);
            //sz.processWorkingMatrix(true, true, true, true, 4, 6);
            //calculate(sz);
            Console.WriteLine(lowestWrongCount);
            Console.Read();
            //Console.WriteLine(sz.workingMatrix.StringRepresentation);
